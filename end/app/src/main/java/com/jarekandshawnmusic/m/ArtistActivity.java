...
public class ArtistActivity extends ActionBarActivity {
    ...
    private CallEventReceiver NoisyAudioReceiver;
    ...
    protected void onResume() {
        ...
        // When this Activity is resumed, music can play.  So the receiver that can stop that music
        // needs to be initialized.
        NoisyAudioReceiver = new CallEventReceiver();
    ...
    protected void onPause() {
        // In this particular application, media only plays when the ArtistActivity is active.
        // We don't want this receiver firing when there's nothing to do, so unregister it when
        // the music isn't going to be played anyway.
